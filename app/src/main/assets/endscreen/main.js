...
//${METADATA_BEGIN}
var META_DATA="[mojo_font.png];type=image/png;width=864;height=13;\n[smile.png];type=image/png;width=700;height=700;\n[smile2.png];type=image/png;width=700;height=700;\n[star.png];type=image/png;width=500;height=476;\n[star2.png];type=image/png;width=500;height=476;\n[w.png];type=image/png;width=800;height=294;\n";
//${METADATA_END}
...
function c_MainApp(){
	c_App.call(this);
	this.m_scale=1.0;
	this.m_imgSmile1=null;
	this.m_imgSmile2=null;
	this.m_imgStar1=null;
	this.m_imgStar2=null;
	this.m_imgWin=null;
	this.m_pageType=0;
	this.m_stars=0;
	this.m_fin=false;
...
c_MainApp.prototype.p_OnCreate=function(){
	this.m_scale=(bb_math_Min(bb_app_DeviceWidth(),bb_app_DeviceHeight()))/640.0;
	this.m_imgSmile1=bb_graphics_LoadImage("smile.png",1,1);
	this.m_imgSmile2=bb_graphics_LoadImage("smile2.png",1,1);
	this.m_imgStar1=bb_graphics_LoadImage("star.png",1,1);
	this.m_imgStar2=bb_graphics_LoadImage("star2.png",1,1);
	this.m_imgWin=bb_graphics_LoadImage("w.png",1,1);
	bb_app_SetUpdateRate(60);
	var t_1=urlParam("type");
	if(t_1=="loose"){
		this.m_pageType=0;
	}else{
		if(t_1=="win"){
			...
			if(t_1=="stars"){
				this.m_pageType=2;
				this.m_stars=parseInt((urlParam("stars")),10);
				if(this.m_stars<=0){
					this.m_pageType=1;
				}
				if(this.m_stars>3){
...
c_MainApp.prototype.p_OnUpdate=function(){
	if(this.m_fin && ((bb_input_MouseDown(0))!=0)){
...
c_MainApp.prototype.p_RenderLoose=function(){
	var t_t=.0;
	...
	if(this.m_mode==0){
		t_t=bb_transition_EaseOutBounce(this.m_ani);
		bb_graphics_DrawImage2(this.m_imgSmile2,(bb_app_DeviceWidth())/2.0,-200.0*this.m_scale*0.5+(t_h*0.5+200.0*this.m_scale*0.5)*t_t,0.0,this.m_scale*0.25,this.m_scale*0.25,0);
	}else{
		bb_graphics_DrawImage2(this.m_imgSmile2,(bb_app_DeviceWidth())/2.0,-200.0*this.m_scale*0.5+(t_h*0.5+200.0*this.m_scale*0.5),0.0,this.m_scale*0.25,this.m_scale*0.25,0);
	}
	if(this.m_ani>0.9){
		this.m_fin=true;
	}
}
c_MainApp.prototype.p_RenderWinNormal=function(){
	var t_t=.0;
	var t_h=(bb_app_DeviceHeight());
	this.m_ani+=0.02;
	if(this.m_ani>0.25){
	...
	if(this.m_ani<1.0){
		t_t=bb_transition_EaseOutElastic(this.m_ani);
		bb_graphics_DrawImage2(this.m_imgWin,(bb_app_DeviceWidth())/2.0,t_h/2.0-225.0*this.m_scale*0.4,0.0,this.m_scale*0.4*t_t,this.m_scale*0.4*t_t,0);
	}else{
		bb_graphics_DrawImage2(this.m_imgWin,(bb_app_DeviceWidth())/2.0,t_h/2.0-225.0*this.m_scale*0.4,0.0,this.m_scale*0.4,this.m_scale*0.4,0);
	}
	if(this.m_ani2>0.0 && this.m_ani2<1.0){
		t_t=bb_transition_EaseOutElastic(this.m_ani2);
		bb_graphics_DrawImage2(this.m_imgSmile1,(bb_app_DeviceWidth())/2.0,t_h/2.0+125.0*this.m_scale*0.4,0.0,this.m_scale*0.3*t_t,this.m_scale*0.3*t_t,0);
	}else{
		if(this.m_ani>0.99){
			bb_graphics_DrawImage2(this.m_imgSmile1,(bb_app_DeviceWidth())/2.0,t_h/2.0+125.0*this.m_scale*0.4,0.0,this.m_scale*0.3,this.m_scale*0.3,0);
		}
	}
	if(this.m_ani2>0.9){
		this.m_fin=true;
...
c_MainApp.prototype.p_RenderWinStars=function(){
	var t_t=.0;
	var t_h=(bb_app_DeviceHeight());
	...
	bb_graphics_DrawImage2(this.m_imgStar2,t_w/2.0-150.0*this.m_scale,t_h*0.5+50.0*this.m_scale,0.0,this.m_scale*0.25,this.m_scale*0.25,0);
	bb_graphics_DrawImage2(this.m_imgStar2,t_w/2.0,t_h*0.5+0.0*this.m_scale,0.0,this.m_scale*0.25,this.m_scale*0.25,0);
	bb_graphics_DrawImage2(this.m_imgStar2,t_w/2.0+150.0*this.m_scale,t_h*0.5+50.0*this.m_scale,0.0,this.m_scale*0.25,this.m_scale*0.25,0);
	if(this.m_ani<1.0){
		t_t=bb_transition_EaseOutElastic(this.m_ani);
		bb_graphics_DrawImage2(this.m_imgWin,(bb_app_DeviceWidth())/2.0,t_h/2.0-225.0*this.m_scale*0.4,0.0,this.m_scale*0.4*t_t,this.m_scale*0.4*t_t,0);
	...
	if(this.m_stars>=1){
		if(this.m_ani2>0.0 && this.m_ani2<1.0){
			t_t=bb_transition_EaseOutElastic(this.m_ani2);
			bb_graphics_DrawImage2(this.m_imgStar1,t_w/2.0-150.0*this.m_scale,t_h*0.5+50.0*this.m_scale,0.0,this.m_scale*0.25*t_t,this.m_scale*0.25*t_t,0);
		}else{
			if(this.m_ani>0.99){
				bb_graphics_DrawImage2(this.m_imgStar1,t_w/2.0-150.0*this.m_scale,t_h*0.5+50.0*this.m_scale,0.0,this.m_scale*0.25,this.m_scale*0.25,0);
			}
		}
	}
	if(this.m_stars>=2){
		if(this.m_ani3>0.0 && this.m_ani3<1.0){
			t_t=bb_transition_EaseOutElastic(this.m_ani3);
			bb_graphics_DrawImage2(this.m_imgStar1,t_w/2.0,t_h*0.5+0.0*this.m_scale,0.0,this.m_scale*0.25*t_t,this.m_scale*0.25*t_t,0);
		}else{
			if(this.m_ani>0.99){
				bb_graphics_DrawImage2(this.m_imgStar1,t_w/2.0,t_h*0.5+0.0*this.m_scale,0.0,this.m_scale*0.25,this.m_scale*0.25,0);
			}
		}
	}
	if(this.m_stars>=3){
		if(this.m_ani4>0.0 && this.m_ani4<1.0){
			t_t=bb_transition_EaseOutElastic(this.m_ani4);
			bb_graphics_DrawImage2(this.m_imgStar1,t_w/2.0+150.0*this.m_scale,t_h*0.5+50.0*this.m_scale,0.0,this.m_scale*0.25*t_t,this.m_scale*0.25*t_t,0);
		}else{
			if(this.m_ani>0.99){
				bb_graphics_DrawImage2(this.m_imgStar1,t_w/2.0+150.0*this.m_scale,t_h*0.5+50.0*this.m_scale,0.0,this.m_scale*0.25,this.m_scale*0.25,0);
	...
	if(this.m_stars==1 && this.m_ani2>0.9){
		this.m_fin=true;
	}
	if(this.m_stars==2 && this.m_ani3>0.9){
		this.m_fin=true;
	}
	if(this.m_stars==3 && this.m_ani4>0.9){
		this.m_fin=true;
	}
}
c_MainApp.prototype.p_OnRender=function(){
	bb_graphics_Cls(255.0,255.0,255.0);
	var t_2=this.m_pageType;
	if(t_2==0){
		this.p_RenderLoose();
	}else{
		if(t_2==1){
			this.p_RenderWinNormal();
		}else{
			if(t_2==2){
				this.p_RenderWinStars();
			}
		}
	}
	return 0;
...
function bb_transition_EaseOutBounce(t_delta){
	if(t_delta<0.0){
		return 0.0;
	}
	if(t_delta>1.0){
	...
	if(t_delta<0.31489){
		return 8.0*(1.1226*t_delta)*(1.1226*t_delta);
	}else{
		if(t_delta<0.65990){
			return 8.0*(1.1226*t_delta-0.54719)*(1.1226*t_delta-0.54719)+0.7;
		}else{
			if(t_delta<0.85908){
				return 8.0*(1.1226*t_delta-0.8526)*(1.1226*t_delta-0.8526)+0.9;
			}else{
				return 8.0*(1.1226*t_delta-1.0435)*(1.1226*t_delta-1.0435)+0.95;
			}
		}
	}
}
...
function bb_transition_EaseOutElastic(t_delta){
	if(t_delta<0.0){
		return 0.0;
	}
	if(t_delta>1.0){
	...
	return 1.0-(1.0-t_delta)*(1.0-t_delta)*(1.0-t_delta)*(1.0-t_delta)*Math.sin((900.0*(1.0-t_delta)-90.0)*D2R);
}
function bbInit(){
	bb_app__app=null;
