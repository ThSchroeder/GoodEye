...
//${METADATA_BEGIN}
var META_DATA="[mojo_font.png];type=image/png;width=864;height=13;\n[pandaa.png];type=image/png;width=339;height=400;\n[pandab.png];type=image/png;width=339;height=400;\n[pandac.png];type=image/png;width=339;height=400;\n";
//${METADATA_END}
...
c_MainApp.prototype.p_OnCreate=function(){
	this.m_img1=bb_graphics_LoadImage("pandaa.png",1,c_Image.m_DefaultFlags);
	this.m_img2=bb_graphics_LoadImage("pandab.png",1,c_Image.m_DefaultFlags);
	this.m_img3=bb_graphics_LoadImage("pandac.png",1,c_Image.m_DefaultFlags);
	this.m_init=true;
...
c_MainApp.prototype.p_OnRender=function(){
	...
	var t_s=(bb_math_Min(t_w,t_h));
	var t_CX=((t_w/2)|0);
	var t_CY=((t_h/2)|0);
	var t_rad=t_s/2.0;
	bb_graphics_Cls(255.0,255.0,255.0);
	bb_graphics_SetColor(0.0,0.0,0.0);
	for(var t_i=0.0;t_i<=360.0;t_i=t_i+30.0){
		bb_color_SetRGB(bb_color_ColorFromHSL(t_i,0.8,0.35,1.0));
		bb_graphics_DrawPoly([t_CX+Math.cos((t_i-15.0)*D2R)*t_rad*0.8,t_CY+Math.sin((t_i-15.0)*D2R)*t_rad*0.8,t_CX+Math.cos((t_i+15.0)*D2R)*t_rad*0.8,t_CY+Math.sin((t_i+15.0)*D2R)*t_rad*0.8,t_CX+Math.cos((t_i+15.0)*D2R)*t_rad*0.5,t_CY+Math.sin((t_i+15.0)*D2R)*t_rad*0.5,t_CX+Math.cos((t_i-15.0)*D2R)*t_rad*0.5,t_CY+Math.sin((t_i-15.0)*D2R)*t_rad*0.5]);
	}
	if((bb_input_MouseDown(0))!=0){
		this.m_currentRotation=(360.0-bb_vec_Vec2Angle(1.0,0.0,bb_input_MouseX()-t_CX,bb_input_MouseY()-t_CY)+360.0) % 360.0;
	}
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+-30.0) % 360.0,0.8,0.18333333333333335,1.0));
	bb_graphics_DrawPoly([t_CX,t_CY,t_CX+Math.cos((this.m_currentRotation+-30.0-7.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+-30.0-7.0)*D2R)*t_rad*0.6,t_CX+Math.cos((this.m_currentRotation+-30.0+7.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+-30.0+7.0)*D2R)*t_rad*0.6]);
	bb_graphics_SetColor(255.0,255.0,255.0);
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+-30.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+-30.0)*D2R)*(t_rad*0.63),t_rad*0.11);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+-30.0) % 360.0,0.8,0.55,1.0));
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+-30.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+-30.0)*D2R)*(t_rad*0.63),t_rad*0.1);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+30.0) % 360.0,0.8,0.18333333333333335,1.0));
	bb_graphics_DrawPoly([t_CX,t_CY,t_CX+Math.cos((this.m_currentRotation+30.0-7.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+30.0-7.0)*D2R)*t_rad*0.6,t_CX+Math.cos((this.m_currentRotation+30.0+7.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+30.0+7.0)*D2R)*t_rad*0.6]);
	bb_graphics_SetColor(255.0,255.0,255.0);
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+30.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+30.0)*D2R)*(t_rad*0.63),t_rad*0.11);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+30.0) % 360.0,0.8,0.55,1.0));
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+30.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+30.0)*D2R)*(t_rad*0.63),t_rad*0.1);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+150.0) % 360.0,0.8,0.18333333333333335,1.0));
	bb_graphics_DrawPoly([t_CX,t_CY,t_CX+Math.cos((this.m_currentRotation+150.0-4.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+150.0-4.0)*D2R)*t_rad*0.6,t_CX+Math.cos((this.m_currentRotation+150.0+4.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+150.0+4.0)*D2R)*t_rad*0.6]);
	bb_graphics_SetColor(255.0,255.0,255.0);
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+150.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+150.0)*D2R)*(t_rad*0.63),t_rad*0.06);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+150.0) % 360.0,0.8,0.55,1.0));
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+150.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+150.0)*D2R)*(t_rad*0.63),t_rad*0.05);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+210.0) % 360.0,0.8,0.18333333333333335,1.0));
	bb_graphics_DrawPoly([t_CX,t_CY,t_CX+Math.cos((this.m_currentRotation+210.0-4.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+210.0-4.0)*D2R)*t_rad*0.6,t_CX+Math.cos((this.m_currentRotation+210.0+4.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+210.0+4.0)*D2R)*t_rad*0.6]);
	bb_graphics_SetColor(255.0,255.0,255.0);
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+210.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+210.0)*D2R)*(t_rad*0.63),t_rad*0.06);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+210.0) % 360.0,0.8,0.55,1.0));
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+210.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+210.0)*D2R)*(t_rad*0.63),t_rad*0.05);
	var t_scale=bb_math_Min2((t_w)/(this.m_img1.p_Width()),(t_h)/(this.m_img1.p_Height()));
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+150.0) % 360.0,0.8,0.5,1.0));
	bb_graphics_DrawRect((t_w),((t_h)-(this.m_img1.p_Height())*t_scale)/2.0,(this.m_img1.p_Width())*t_scale,(this.m_img1.p_Height())*t_scale);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+210.0) % 360.0,0.8,0.3,1.0));
	bb_graphics_DrawImage2(this.m_img1,(t_w),((t_h)-(this.m_img1.p_Height())*t_scale)/2.0,0.0,t_scale,t_scale,0);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+30.0) % 360.0,0.8,0.6,1.0));
	bb_graphics_DrawImage2(this.m_img2,(t_w),((t_h)-(this.m_img1.p_Height())*t_scale)/2.0,0.0,t_scale,t_scale,0);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+-30.0) % 360.0,0.8,0.3,1.0));
	bb_graphics_DrawImage2(this.m_img3,(t_w),((t_h)-(this.m_img1.p_Height())*t_scale)/2.0,0.0,t_scale,t_scale,0);
	return 0;
}
...
function bb_color_Create(t_r,t_g,t_b,t_a){
	return ((((t_r*255.0)|0)&255)<<24)+((((t_g*255.0)|0)&255)<<16)+((((t_b*255.0)|0)&255)<<8)+(((t_a*255.0)|0)&255);
}
function bb_color_ColorFromHSL(t_h,t_s,t_l,t_a){
	var t_r=.0;
	var t_g=.0;
	var t_b=.0;
	var t_color=0;
	...
	t_c=(1.0-bb_math_Abs2(2.0*t_l-1.0))*t_s;
	t_m=1.0*(t_l-0.5*t_c);
	t_x=t_c*(1.0-bb_math_Abs2(t_h/60.0 % 2.0-1.0));
	if(t_h>=0.0 && t_h<60.0){
		t_color=bb_color_Create(t_c+t_m,t_x+t_m,t_m,t_a);
	}else{
		if(t_h>=60.0 && t_h<120.0){
			t_color=bb_color_Create(t_x+t_m,t_c+t_m,t_m,t_a);
		}else{
			if(t_h>=120.0 && t_h<180.0){
				t_color=bb_color_Create(t_m,t_c+t_m,t_x+t_m,t_a);
			}else{
				if(t_h>=180.0 && t_h<240.0){
					t_color=bb_color_Create(t_m,t_x+t_m,t_c+t_m,t_a);
				}else{
					if(t_h>=240.0 && t_h<300.0){
						t_color=bb_color_Create(t_x+t_m,t_m,t_c+t_m,t_a);
					}else{
						if(t_h>=300.0 && t_h<360.0){
							t_color=bb_color_Create(t_c+t_m,t_m,t_x+t_m,t_a);
						}else{
							t_color=bb_color_Create(t_m,t_m,t_m,t_a);
						}
					}
				}
			}
...
function bb_vec_Vec2Angle(t_ax,t_ay,t_bx,t_by){
	return (Math.atan2(t_ay,t_ax)*R2D)-(Math.atan2(t_by,t_bx)*R2D);
}
function bb_vec_Vec2Angle2(t_vec1,t_bx,t_by){
	return (Math.atan2(t_vec1[1],t_vec1[0])*R2D)-(Math.atan2(t_by,t_bx)*R2D);
}
function bb_vec_Vec2Angle3(t_ax,t_ay,t_vec2){
	return (Math.atan2(t_ay,t_ax)*R2D)-(Math.atan2(t_vec2[1],t_vec2[0])*R2D);
}
function bb_vec_Vec2Angle4(t_vec1,t_vec2){
	return (Math.atan2(t_vec1[1],t_vec1[0])*R2D)-(Math.atan2(t_vec2[1],t_vec2[0])*R2D);
}
