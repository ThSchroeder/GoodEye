...
//${METADATA_BEGIN}
var META_DATA="[mojo_font.png];type=image/png;width=864;height=13;\n[panda1.png];type=image/png;width=339;height=400;\n[panda2.png];type=image/png;width=339;height=400;\n";
//${METADATA_END}
...
c_MainApp.prototype.p_OnCreate=function(){
	this.m_img1=bb_graphics_LoadImage("panda1.png",1,c_Image.m_DefaultFlags);
	this.m_img2=bb_graphics_LoadImage("panda2.png",1,c_Image.m_DefaultFlags);
	this.m_init=true;
...
c_MainApp.prototype.p_OnRender=function(){
	...
	bb_color_SetRGB(bb_color_ColorFromHSL(this.m_currentRotation,0.8,0.18333333333333335,1.0));
	bb_graphics_DrawPoly([t_CX,t_CY,t_CX+Math.cos((this.m_currentRotation-7.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation-7.0)*D2R)*t_rad*0.6,t_CX+Math.cos((this.m_currentRotation+7.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+7.0)*D2R)*t_rad*0.6]);
	bb_graphics_SetColor(255.0,255.0,255.0);
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation)*D2R)*(t_rad*0.63),t_rad*0.11);
	bb_color_SetRGB(bb_color_ColorFromHSL(this.m_currentRotation,0.8,0.55,1.0));
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation)*D2R)*(t_rad*0.63),t_rad*0.1);
	...
	bb_color_SetRGB(bb_color_ColorFromHSL(this.m_currentRotation,0.8,0.4,1.0));
	bb_graphics_DrawRect((t_w),((t_h)-(this.m_img1.p_Height())*t_scale)/2.0,(this.m_img1.p_Width())*t_scale,(this.m_img1.p_Height())*t_scale);
	bb_graphics_SetColor(255.0,255.0,255.0);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+150.0) % 360.0,0.8,0.7,1.0));
