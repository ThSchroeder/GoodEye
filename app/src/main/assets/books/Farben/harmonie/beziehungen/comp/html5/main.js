...
//${METADATA_BEGIN}
var META_DATA="[mojo_font.png];type=image/png;width=864;height=13;\n[panda.png];type=image/png;width=341;height=400;\n";
//${METADATA_END}
...
c_MainApp.prototype.p_OnCreate=function(){
	this.m_img1=bb_graphics_LoadImage("panda.png",1,c_Image.m_DefaultFlags);
...
c_MainApp.prototype.p_OnRender=function(){
	...
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+180.0) % 360.0,0.8,0.18333333333333335,1.0));
	bb_graphics_DrawPoly([t_CX,t_CY,t_CX+Math.cos((this.m_currentRotation+180.0-4.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+180.0-4.0)*D2R)*t_rad*0.6,t_CX+Math.cos((this.m_currentRotation+180.0+4.0)*D2R)*t_rad*0.6,t_CY+Math.sin((this.m_currentRotation+180.0+4.0)*D2R)*t_rad*0.6]);
	bb_graphics_SetColor(255.0,255.0,255.0);
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+180.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+180.0)*D2R)*(t_rad*0.63),t_rad*0.06);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+180.0) % 360.0,0.8,0.55,1.0));
	bb_graphics_DrawCircle(t_CX+Math.cos((this.m_currentRotation+180.0)*D2R)*(t_rad*0.63),t_CY+Math.sin((this.m_currentRotation+180.0)*D2R)*(t_rad*0.63),t_rad*0.05);
	var t_scale=bb_math_Min2((t_w)/(this.m_img1.p_Width()),(t_h)/(this.m_img1.p_Height()));
	bb_color_SetRGB(bb_color_ColorFromHSL(this.m_currentRotation,0.8,0.7,1.0));
	bb_graphics_DrawRect((t_w),((t_h)-(this.m_img1.p_Height())*t_scale)/2.0,(this.m_img1.p_Width())*t_scale,(this.m_img1.p_Height())*t_scale);
	bb_graphics_SetColor(255.0,255.0,255.0);
	bb_color_SetRGB(bb_color_ColorFromHSL((this.m_currentRotation+180.0) % 360.0,0.8,0.3,1.0));
